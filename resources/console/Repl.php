...
/**
 * This file is part of ramsey/php-library-coding-standard
 *
 * ramsey/php-library-coding-standard is open source software: you can distribute
...
class Repl
{
    public static function start(): void
    {
        ...
        $config = new Configuration([
            'startupMessage' => '<info>'
                . 'Welcome to the REPL for ramsey/php-library-coding-standard!'
                . '</info>',
